...
export const PHASES: Phase[] = [
  {
    ...
    short: "ECI announces poll dates",
    duration: "6–8 weeks before",
    weeksOffset: -8,
    icon: "📢",
    details:
      "The Election Commission of India holds a press conference declaring poll dates, model code of conduct kicks in immediately.",
  },
  {
    id: 2,
    title: "Notification Issued",
    short: "Official gazette notification",
    duration: "5–6 weeks before",
    weeksOffset: -6,
    icon: "📰",
    details:
      "Returning Officer issues notification calling upon constituency to elect a representative.",
  },
  {
    id: 3,
    title: "Nominations Filed",
    short: "Candidates submit papers",
    duration: "1 week",
    weeksOffset: -5,
    icon: "📝",
    details:
      "Candidates file nomination papers with deposits and affidavits declaring assets, criminal records.",
  },
  {
    id: 4,
    title: "Scrutiny",
    short: "Validation of nominations",
    duration: "1 day",
    weeksOffset: -4,
    icon: "🔍",
  ...
  },
  {
    ...
    short: "Last chance to pull out",
    duration: "2 days",
    weeksOffset: -4,
    icon: "↩️",
    details:
      "Candidates may withdraw; final list of contestants is published with allotted symbols.",
  },
  {
    id: 6,
    title: "Campaigning",
    short: "Rallies, manifestos, debates",
    duration: "2–3 weeks",
    weeksOffset: -3,
    icon: "📣",
  ...
  },
  {
    ...
    short: "48-hour campaign blackout",
    duration: "48 hours",
    weeksOffset: 0,
    icon: "🤫",
  ...
  },
  {
    id: 8,
    title: "Polling Day(s)",
    short: "Phased voting across India",
    duration: "4–5 weeks (phased)",
    weeksOffset: 0,
    icon: "🗳️",
...
export const QUIZ: { q: string; options: string[]; answer: number; explain: string }[] = [
  ...
  {
    q: "Who announces the election schedule?",
    options: ["President", "Prime Minister", "Election Commission of India", "Supreme Court"],
    answer: 2,
    explain: "ECI is an autonomous constitutional authority that conducts all elections.",
  },
  {
    q: "What comes immediately after Nominations?",
    options: ["Polling", "Scrutiny", "Counting", "Campaigning"],
    answer: 1,
    explain: "Returning Officer scrutinises papers the day after nominations close.",
  },
  {
    q: "How many days before polling can you typically register as a voter?",
  ...
  },
  {
    ...
    options: [
      "A dress code",
      "Rules for candidates & parties during elections",
      "Voter ID format",
      "Campaign budget",
    ],
    answer: 1,
  ...
  {
    q: "What machine is used to verify votes?",
    options: ["EVM", "VVPAT", "Both EVM & VVPAT", "Paper ballot"],
    answer: 2,
