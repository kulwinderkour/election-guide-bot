  ...
  head: () => ({
    meta: [
      { title: "ElectionGuide Bot — Your AI guide to Indian elections" },
      {
        name: "description",
        content:
          "Chat with an AI election expert, explore the 12 phases, check voter eligibility, and test your knowledge with quizzes.",
      },
      { property: "og:title", content: "ElectionGuide Bot — Your AI guide to Indian elections" },
      {
        property: "og:description",
        content:
          "Chat with an AI election expert, explore the 12 phases, check voter eligibility, and test your knowledge.",
      },
    ],
  }),
});
          ...
          <div className="relative mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-28 lg:py-36">
            <div className="max-w-2xl animate-fade-up">
              ...
              <p className="mt-5 max-w-xl text-base text-white/80 sm:text-lg">
                A conversational guide through the 12 phases — from ECI's poll-date announcement to
                the swearing-in. Personalized to your age, state, and curiosity.
              </p>
              <div className="mt-8 flex flex-wrap gap-3">
                <Link
                  to="/chat"
                  className="group inline-flex items-center gap-2 rounded-xl bg-saffron px-6 py-3 text-sm font-semibold text-saffron-foreground shadow-elegant transition-all hover:scale-[1.02] hover:shadow-glow"
                >
                  Start chatting{" "}
              ...
              <div className="mt-10 flex flex-wrap items-center gap-6 text-xs text-white/60">
                <span className="flex items-center gap-1.5">
                  <Vote className="h-4 w-4" /> ECI-aligned content
                </span>
                <span>·</span>
            ...
            {[
              {
                ...
                icon: MessageCircle,
                title: "AI Chat",
                desc: "Ask anything — from EVM mechanics to nomination deadlines.",
              ...
              },
              {
                ...
                icon: CalendarClock,
                title: "12 Phases",
                desc: "Visual timeline of every step from announcement to oath.",
              ...
              },
              {
                ...
                icon: ShieldCheck,
                title: "Eligibility",
                desc: "Quick checker — am I ready to register and vote?",
                accent: "bg-india-green/15 text-india-green",
              },
              {
                to: "/quiz" as const,
                icon: Sparkles,
                title: "Quiz Mode",
                desc: "6 questions to test your civic knowledge.",
