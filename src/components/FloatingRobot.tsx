...
const FloatingRobot = () => {
  return (
    <div className="fixed bottom-6 right-6 z-50 animate-float">
      <Link
        to="/chat"
        aria-label="Chat with ElectionGuide Bot"
      ...
      >
        ...
        <div className="absolute -bottom-1 -right-1 w-1.5 h-1.5">
          <Sparkles
            className="w-full h-full text-pink-400 animate-spin"
        ...
        <div className="relative w-full h-full flex items-center justify-center">
          ...
          <div className="absolute -top-1 left-1/2 transform -translate-x-1/2">
            <div className="w-6 h-4 bg-gradient-to-b from-blue-700 to-blue-900 rounded-t-sm relative animate-pulse">
              ...
              <div
                className="absolute top-0.5 right-1 w-0.5 h-0.5 bg-yellow-200 rounded-full animate-ping"
          ...
          <div className="relative">
            ...
            <div className="flex gap-3 mb-1">
              <div className="relative">
                ...
                <div
                  className="absolute top-0 right-0 w-0.5 h-0.5 bg-white rounded-full animate-ping"
              ...
              <div className="relative">
                <div className="w-3 h-3 bg-gradient-to-br from-white to-gray-100 rounded-full border border-gray-300 shadow-sm animate-pulse"></div>
                <div
                  className="absolute top-1 left-1 w-1.5 h-1.5 bg-gradient-to-br from-blue-600 to-blue-800 rounded-full animate-pulse"
            ...
            <div
              className="absolute top-2 -right-2 w-2 h-1.5 bg-gradient-to-br from-pink-200 to-pink-300 rounded-full opacity-60 animate-pulse"
